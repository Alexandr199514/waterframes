...
public class WFRegistry {
    ...
    public static class ModEvents {
        ...
        public static void init(FMLCommonSetupEvent event) {
            ...
            CONTROL_NET.registerType(LoopPacket.class, LoopPacket::new);
            CONTROL_NET.registerType(MutePacket.class, MutePacket::new);
            CONTROL_NET.registerType(PausePacket.class, PausePacket::new);
            CONTROL_NET.registerType(TimePacket.class, TimePacket::new);
            CONTROL_NET.registerType(VolumePacket.class, VolumePacket::new);
            CONTROL_NET.registerType(VolumeRangePacket.class, VolumeRangePacket::new);
        }
